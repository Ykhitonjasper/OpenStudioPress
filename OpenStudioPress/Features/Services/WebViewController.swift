...
public final class WebViewController: UIViewController, WKNavigationDelegate, WKUIDelegate {
    ...
    enum Tuning {
        ...
        /// Weighted DOM score: text + blocks×2 + media×20. Spinner shells with
        /// a few layout nodes clear ≥ 9; empty/white stays near 0.
        static let minimumContentScore = Timeouts.minimumContentScore
