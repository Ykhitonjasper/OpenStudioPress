...
final class AppLaunch {
    ...
    private func revealWeb(
        ...
        let instant =
            tier == .warm
            && probeElapsed < Timeouts.warmInstantThreshold
        ...
        let fade: TimeInterval =
            tier == .warm ? Timeouts.warmRevealCrossfade : Timeouts.revealCrossfade
    ...
    private func waitForContentReady(
        ...
        let remaining = tier.launchBudget - Date().timeIntervalSince(began)
